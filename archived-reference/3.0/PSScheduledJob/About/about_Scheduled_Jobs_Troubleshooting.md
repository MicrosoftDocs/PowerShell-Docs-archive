...
ms.date: 06/09/2017
online version: https://learn.microsoft.com/previous-versions/powershell/module/psscheduledjob/about/about_scheduled_jobs_troubleshooting?view=powershell-3.0&WT.mc_id=ps-gethelp
schema: 2.0.0
...
For descriptions of the scheduled job options, see [New-ScheduledJobOption](xref:Microsoft.PowerShell.Core.New-ScheduledJobOption).
