...
ms.date: 06/09/2017
online version: https://learn.microsoft.com/previous-versions/powershell/module/microsoft.powershell.management/join-path?view=powershell-3.0&WT.mc_id=ps-gethelp
schema: 2.0.0
title: Join-Path
---
# Join-Path
