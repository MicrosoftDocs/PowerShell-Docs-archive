...
ms.date: 06/09/2017
online version: https://learn.microsoft.com/previous-versions/powershell/module/microsoft.powershell.core/about/about_comment_based_help?view=powershell-3.0&WT.mc_id=ps-gethelp
schema: 2.0.0
...
The [Get-Help](xref:Microsoft.PowerShell.Core.Get-Help.md) cmdlet displays
