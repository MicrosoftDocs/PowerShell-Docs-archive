...
ms.date: 03/26/2019
online version: https://learn.microsoft.com/previous-versions/powershell/module/microsoft.powershell.core/get-pssessionconfiguration?view=powershell-3.0&WT.mc_id=ps-gethelp
schema: 2.0.0
...
----                      ---------  -------------        ----------
microsoft.powershell      3.0                             BUILTIN\Administrators AccessAll...
microsoft.powershell32    3.0                             BUILTIN\Administrators AccessAll...
```
...
----                      ---------  -------------        ----------                          --------------
microsoft.powershell      3.0                             BUILTIN\Administrators AccessAll... server02.corp.fabrikam.com
microsoft.powershell32    3.0                             BUILTIN\Administrators AccessAll... server02.corp.fabrikam.com
MyX86Shell                3.0        c:\test\x86Shell.ps1 BUILTIN\Administrators AccessAll... server02.corp.fabrikam.com
```
