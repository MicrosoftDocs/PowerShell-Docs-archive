...
ms.date: 04/23/2019
online version: https://learn.microsoft.com/previous-versions/powershell/module/Microsoft.PowerShell.Utility/export-csv?view=powershell-3.0&WT.mc_id=ps-gethelp
schema: 2.0.0
title: Export-Csv
---
# Export-Csv
...
are represented by the property value name. `Export-CSV does not export the methods of the object.
