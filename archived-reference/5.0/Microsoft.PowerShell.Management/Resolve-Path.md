...
ms.date: 08/23/2018
online version: https://learn.microsoft.com/previous-versions/powershell/module/microsoft.powershell.management/resolve-path?view=powershell-5.0&WT.mc_id=ps-gethelp
schema: 2.0.0
title: Resolve-Path
---
# Resolve-Path
