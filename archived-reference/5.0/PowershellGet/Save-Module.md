...
ms.date: 07/01/2019
online version: https://learn.microsoft.com/previous-versions/powershell/module/powershellget/save-module?view=powershell-5.0&WT.mc_id=ps-gethelp
schema: 2.0.0
title: Save-Module
---
...
```
Save-Module [-Name] <String[]> [-MinimumVersion <Version>] [-MaximumVersion <Version>]
 [-RequiredVersion <Version>] [-Repository <String[]>] -LiteralPath <String> [-Force] [-WhatIf]
...
```
Save-Module [-InputObject] <PSObject[]> -Path <String> [-Force] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
