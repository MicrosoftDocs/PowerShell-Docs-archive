...
data type it acts upon. For example, instead of using the [Hashtable][01]
class, which allows keys and values to be of any type, you can use the
[`Dictionary<TKey,TValue>`][02] generic class and specify the types allowed for
the **key** and **value** properties. Generics provide increased code
...
blog post [Invoking generic methods on non-generic classes in PowerShell][04].
...
For more information, see [Generics in .NET][03].
...
[02]: xref:System.Collections.Generic.Dictionary`2
[03]: /dotnet/standard/generics/
[04]: https://www.leeholmes.com/invoking-generic-methods-on-non-generic-classes-in-powershell/
