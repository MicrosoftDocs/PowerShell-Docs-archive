...
Locale: en-US
ms.date: 10/18/2018
online version: https://learn.microsoft.com/powershell/module/microsoft.powershell.core/about/about_environment_provider?view=powershell-7.3&WT.mc_id=ps-gethelp
schema: 2.0.0
...
[System.Collections.DictionaryEntry][01] class. The name of the variable is the
...
> [Get-ChildItem][05], `cd` is an alias for [Set-Location][10]. and `pwd` is an
> alias for [Get-Location][07].
...
[Get-Help][03] command in a file system drive or use the `-Path` parameter of
[Get-Help][03] to specify a file system drive.
...
<!-- link references -->
[01]: /dotnet/api/system.collections.dictionaryentry
[02]: about_Providers.md
[03]: xref:Microsoft.PowerShell.Core.Get-Help
[04]: xref:Microsoft.PowerShell.Management.Clear-Item
[05]: xref:Microsoft.PowerShell.Management.Get-ChildItem
[06]: xref:Microsoft.PowerShell.Management.Get-Item
[07]: xref:Microsoft.PowerShell.Management.Get-Location
[08]: xref:Microsoft.PowerShell.Management.New-Item
[09]: xref:Microsoft.PowerShell.Management.Remove-Item
