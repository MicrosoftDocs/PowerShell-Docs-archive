...
ms.date: 06/09/2017
online version: https://docs.microsoft.com/previous-versions/powershell/module/microsoft.powershell.management/join-path?view=powershell-4.0&WT.mc_id=ps-gethelp
schema: 2.0.0
title: Join-Path
---
# Join-Path
