...
ms.date: 10/17/2019
online version: https://docs.microsoft.com/previous-versions/powershell/module/microsoft.powershell.core/invoke-command?view=powershell-4.0&WT.mc_id=ps-gethelp
schema: 2.0.0
