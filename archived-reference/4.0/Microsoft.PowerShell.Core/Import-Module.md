...
ms.date: 06/09/2017
online version: https://learn.microsoft.com/previous-versions/powershell/module/microsoft.powershell.core/import-module?view=powershell-4.0&WT.mc_id=ps-gethelp
schema: 2.0.0
title: Import-Module
---
...
This example imports the members of the `BitsTransfer` module into the current session. The
